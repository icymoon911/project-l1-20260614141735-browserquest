...
define(['infomanager', 'bubble', 'renderer', 'map', 'animation', 'sprite', 'tile',
        ...
        'item', 'mob', 'npc', 'player', 'character', 'chest', 'achievements', 'handlers', 'config', '../../shared/js/gametypes'],
function(InfoManager, BubbleManager, Renderer, Map, Animation, Sprite, AnimatedTile,
         Warrior, GameClient, AudioManager, Updater, Transition, Pathfinder,
         Item, Mob, Npc, Player, Character, Chest, AchievementManager, Handlers, config) {
    ...
    var Game = Class.extend({
        ...
        initAchievements: function() {
            ...
            this.achievementManager.init(this);
        },

        getAchievementById: function(id) {
            return this.achievementManager.getById(id);
        },
        ...
        connect: function(started_callback) {
            ...
            // Delegate all message handler registration to the Handlers module
            Handlers.register(this, started_callback);
        },
        ...
        makeNpcTalk: function(npc) {
            ...
            if(npc) {
                ...
                this.achievementManager.onNpcTalked(npc);
            }
        },
        ...
        restart: function() {
            ...
            this.achievementManager.onPlayerRevive();
        ...
        tryUnlockingAchievement: function(name) {
            this.achievementManager.tryUnlock(name);
        },
